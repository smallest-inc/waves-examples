...
VOICE_ID = "muskan_indian_female"  # Voice id that you wish to use
TIMEOUT = 2  # Timeout in seconds for receiving a message
CLOSE_CONNECTION_TIMEOUT = 500  # Timeout for your websocket connection
SENTENCES = ["  ", "Bharat ek vishaal desh hai, ","jisme vibhinna bhashaye, sanskratiyan, ", "aur paramparayein samahit hai.", " "]
